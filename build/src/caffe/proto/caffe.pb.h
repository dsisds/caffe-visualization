...
const LayerParameter_LayerType LayerParameter_LayerType_LayerType_MAX = LayerParameter_LayerType_DUMMY_DATA;
...
inline void LayerParameter::set_type(::caffe::LayerParameter_LayerType value) {
  GOOGLE_DCHECK(::caffe::LayerParameter_LayerType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void LayerParameter::set_blob_share_mode(int index, ::caffe::LayerParameter_DimCheckMode value) {
  GOOGLE_DCHECK(::caffe::LayerParameter_DimCheckMode_IsValid(value));
