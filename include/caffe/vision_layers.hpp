...
class ConvolutionLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  virtual void Reconstruct_gpu(const vector<Blob<Dtype>*> &top, 
	  vector<Blob<Dtype>*>* bottom);
  virtual void SetTop_cpu(vector<Blob<Dtype>*>* bottom);
...
class LRNLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  virtual Dtype CrossChannelReconstruct_cpu(const vector<Blob<Dtype>*>& top, 
		vector<Blob<Dtype>*>* bottom);
  virtual Dtype CrossChannelReconstruct_gpu(const vector<Blob<Dtype>*>& top, 
		vector<Blob<Dtype>*>* bottom);
  virtual void Reconstruct_cpu(const vector<Blob<Dtype>*>& top, 
	  vector<Blob<Dtype>*>* bottom);
  virtual void Reconstruct_gpu(const vector<Blob<Dtype>*>& top, 
