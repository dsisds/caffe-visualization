...
class Layer {
 public:
  ...
  inline void Reconstruct(const vector<Blob<Dtype>*> &top, 
	  vector<Blob<Dtype>*>* bottom);

  inline void SetTop(vector<Blob<Dtype>*>* bottom);
 ...
 protected:
  ...
  virtual void Reconstruct_cpu(const vector<Blob<Dtype>*> &top, 
	  vector<Blob<Dtype>*>* bottom) = 0;
  virtual void Reconstruct_gpu(const vector<Blob<Dtype>*> &top, 
	  vector<Blob<Dtype>*>* bottom){
		  // LOG(WARNING) << "Using CPU code as backup.";
		  Reconstruct_cpu(top, bottom);
  }
  virtual void SetTop_cpu(vector<Blob<Dtype>*>* bottom) = 0;
  virtual void SetTop_gpu(vector<Blob<Dtype>*>* bottom){
	  SetTop_cpu(bottom);
  }
...
template <typename Dtype>
inline void Layer<Dtype>::Reconstruct(const vector<Blob<Dtype>*> &top, 
	  vector<Blob<Dtype>*>* bottom){
		  switch (Caffe::mode())
		  {
		  case Caffe::CPU:
...
template <typename Dtype>
inline void Layer<Dtype>::SetTop(vector<Blob<Dtype>*>* bottom){
	switch (Caffe::mode())
		  {
		  case Caffe::CPU:
			  SetTop_cpu(bottom);
